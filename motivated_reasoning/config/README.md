...
- `env_config_templates`: contains templates to generate initial states for each environment class. We used claude to generate the initial states using these templates. The code for this is in `motivated_reasoning/generate_initial_states/generate_initial_states.py`.
